  ...
  return (
    <nav className="min-h-[80px] flex flex-col md:flex-row md:text-center justify-between bg-primary text-components">
      ...
      <div className="h-20 aspect-square p-3 -ml-1 md:absolute">
        <Link to="/">
          <svg className="h-full fill-components" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50">
      ...
      <button onClick={e => setToggle( !toggle )} className="h-20 absolute top-0 right-0 md:static md:hidden aspect-square p-4 md:-mr-1">
        <svg className="h-full fill-components" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">

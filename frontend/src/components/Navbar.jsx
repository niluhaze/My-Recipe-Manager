...
const Navbar = () => {
  ...
  return (
    <nav className="min-h-[64px] flex flex-col md:flex-row md:text-center justify-center bg-primary text-components">
      {/* Logo and Links Wrapper */}
      <div className="md:max-w-[1400px] md:flex md:flex-grow md:justify-between">
        {/* Logo */}
        <div className="h-16 aspect-square p-3 -ml-1">
          <Link to="/">
            <svg

/*
  A middleware function which gets a recipe based on its urlName.
  Used to avoid duplicate code for simple requests.
*/

const Recipe = require("../models/recipe");

const VARS_FOR_RECIPE_PAGE = {
  // specifies recipe variables (not) needed for the recipe list
  _id: 0,
  __v: 0,
};
